			...
			<div className='product__items '>
				...
				<div className='product__items--thumbnail'>
					<Link className='product__items--link' href='product-details'>
						<Image className='product__items--img product__primary--img' src={`/images/products/${image}`} width={282} height={310} alt='product-img' />
						<Image className='product__items--img product__secondary--img' src={`/images/products/${image}`} width={282} height={310} alt='product-img' />
					</Link>
