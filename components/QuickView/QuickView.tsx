		...
		<div className='modal' id='modal1' data-animation='slideInUp'>
			<div className='modal-dialog quickview__main--wrapper'>
				<header className='modal-header quickview__header'>
					<button className='close-modal quickview__close--btn' aria-label='close modal' data-close>
						✕
					</button>
				</header>
									...
									<Swiper spaceBetween={50} slidesPerView={5}>
										<SwiperSlide>
											<div className='product__media--nav__items'>
												<Image className='product__media--nav__items--img' src='/images/products/small-product7.png' alt='product-nav-img' width={90} height={98} />
											</div>
										</SwiperSlide>
										<SwiperSlide>
											<div className='product__media--nav__items'>
												<Image className='product__media--nav__items--img' src='/images/products/small-product8.png' alt='product-nav-img' width={90} height={98} />
											</div>
										</SwiperSlide>
										<SwiperSlide>
											<div className='product__media--nav__items'>
												<Image className='product__media--nav__items--img' src='/images/products/small-product9.png' alt='product-nav-img' width={90} height={98} />
											</div>
										</SwiperSlide>
										<SwiperSlide>
											<div className='product__media--nav__items'>
												<Image className='product__media--nav__items--img' src='/images/products/small-product10.png' alt='product-nav-img' width={90} height={98} />
											</div>
										</SwiperSlide>
										<SwiperSlide>
											<div className='product__media--nav__items'>
												<Image className='product__media--nav__items--img' src='/images/products/small-product11.png' alt='product-nav-img' width={90} height={98} />
											</div>
										</SwiperSlide>
										<SwiperSlide>
											<div className='product__media--nav__items'>
												<Image className='product__media--nav__items--img' src='/images/products/small-product12.png' alt='product-nav-img' width={90} height={98} />
											</div>
										</SwiperSlide>
									</Swiper>
								</div>
								...
								<form action='#'>
									...
									<div className='product__variant'>
										<div className='product__variant--list mb-10'>
											<fieldset className='variant__input--fieldset'>
												...
												<label className='variant__color--value red' htmlFor='color-red1' title='Red'>
													<Image className='variant__color--value__img' src='/images/products/product1.png' width={282} height={310} alt='variant-color-img' />
												</label>
												<input id='color-red2' name='color' type='radio' />
												<label className='variant__color--value red' htmlFor='color-red2' title='Black'>
													<Image className='variant__color--value__img' src='/images/products/product2.png' width={282} height={310} alt='variant-color-img' />
												</label>
										...
										<div className='quickview__variant--list quantity d-flex align-items-center mb-15'>
											...
											<button className='primary__btn quickview__cart--btn' type='submit'>
												Add To Cart
											</button>
										</div>
