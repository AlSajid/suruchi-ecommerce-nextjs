					...
					<div className='footer__widget footer__widget--width'>
						...
						<div className='footer__widget--inner'>
							<p className='footer__widget--desc text-ofwhite mb-20'>
								Lorem ipsum dolor sit amet, consectetur adipisici ti elit <br /> seddo
								eiusmod tempor incididunt utlabore et dolore <br /> magna aliqua enim ad
								minim veniam quisnostrud <br /> exercitation ullamco
							</p>
