			...
			<div className='container'>
				<div className='checkout__page--inner d-flex'>
                    ...
                    <header className="main__header checkout__mian--header mb-30">
                        <h1 className="main__logo--title"><a className="logo logo__left mb-20" href="index"><Image src="assets/img/logo/nav-log.png" alt="logo"/></a></h1>
                                        ...
                                        <tbody className="summary__table--body">
                                                ...
                                                <td className=" summary__table--list">
                                                    <div className="product__image two  d-flex align-items-center">
                                                        <div className="product__thumbnail border-radius-5">
                                                            <a href="product-details"><Image className="border-radius-5" src="assets/img/product/small-product7.png" alt="cart-product"/></a>
                                                            <span className="product__thumbnail--quantity">1</span>
                                                        </div>
                                                        <div className="product__description">
                                                            <h3 className="product__description--name h4"><a href="product-details">Fresh-whole-fish</a></h3>
                                            ...
                                            <tr className="summary__table--items">
                                                <td className=" summary__table--list">
                                                    <div className="cart__product d-flex align-items-center">
                                                        <div className="product__thumbnail border-radius-5">
                                                            <a href="product-details"><Image className="border-radius-5" src="assets/img/product/small-product2.png" alt="cart-product" width={100} height={120}/></a>
                                                            <span className="product__thumbnail--quantity">1</span>
                                                        </div>
                                                        <div className="product__description">
                                                            <h3 className="product__description--name h4"><a href="product-details">Vegetable-healthy</a></h3>
                                            ...
                                            <tr className=" summary__table--items">
                                                <td className=" summary__table--list">
                                                    <div className="cart__product d-flex align-items-center">
                                                        <div className="product__thumbnail border-radius-5">
                                                            <a href="product-details"><Image className="border-radius-5" src="assets/img/product/small-product4.png" alt="cart-product"  width={100} height={120} /></a>
                                                            <span className="product__thumbnail--quantity">1</span>
                                                        </div>
                                                        <div className="product__description">
                                                            <h3 className="product__description--name h4"><a href="product-details">Raw-onions-surface</a></h3>
                        ...
                        <nav>
                            <ol className="breadcrumb checkout__breadcrumb d-flex">
                                <li className="breadcrumb__item breadcrumb__item--completed d-flex align-items-center">
                                    ...
                                    <svg className="readcrumb__chevron-icon" xmlns="http://www.w3.org/2000/svg" width="17.007" height="16.831" viewBox="0 0 512 512"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="48" d="M184 112l144 144-144 144"></path></svg>
                                </li>
                    ...
                    <main className="main__content_wrapper">
                        <form action="#">
                            ...
                            <div className="checkout__content--step section__shipping--address">
                                ...
                                <div className="checkout__content--step__inner3 border-radius-5">
                                    <div className="checkout__address--content__header d-flex align-items-center justify-content-between">
                                        ...
                                        <span className="heckout__address--content__icon"><Image src="assets/img/icon/credit-card.svg" alt="card"/></span>
                                    </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-6 mb-12">
                                                <div className="checkout__input--list checkout__input--select select">
                                                    <label className="checkout__select--label" for="country">Country/region</label>
                            ...
                            <div className="checkout__content--step__footer d-flex align-items-center">
                                <a className="continue__shipping--btn primary__btn border-radius-5" href="checkout-3">Pay now</a>
                                <a className="previous__link--content" href="shop">Return to shipping</a>
                            </div>
                        </form>
                    </main>
                    <footer className="main__footer checkout__footer">
                        <p className="copyright__content">Copyright © 2022 <a className="copyright__content--link text__primary" href="index">Suruchi</a> . All Rights Reserved.Design By Suruchi</p>
                    </footer>
                </div>
