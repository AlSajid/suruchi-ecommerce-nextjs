							...
							<div className='product__items product__list--items d-flex'>
								...
								<div className='product__list--items__content'>
									...
									<p className='product__list--items__content--desc d-none d-xl-block mb-15'>
										Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi, natus at rem ab quae amet molestiae quod voluptates, illo exercitationem numquam ipsa. Est fuga ex
										ipsum alias ipsa quibusdam magni harum labore voluptate, esse deserunt saepe eveniet.
									</p>
									<ul className='product__items--action d-flex'>
										<li className='product__items--action__list'>
											<Link className='product__items--action__btn add__to--cart' href='cart'>
