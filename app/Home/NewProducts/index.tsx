		...
		<section className='product__section section--padding pt-0'>
			<div className='container-fluid'>
				...
				<ul className='product__tab--one product__tab--primary__btn d-flex justify-content-center mb-50'>
					<li className='product__tab--primary__btn__list active' data-toggle='tab' data-target='#featured'>
						Featured
					</li>
					<li className='product__tab--primary__btn__list' data-toggle='tab' data-target='#trending'>
						Trending
					</li>
					<li className='product__tab--primary__btn__list' data-toggle='tab' data-target='#newarrival'>
						New Arrival
					</li>
				</ul>
