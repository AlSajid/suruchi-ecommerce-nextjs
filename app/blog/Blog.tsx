						...
						<div className='col mb-30'>
							<div className='blog__items'>
								...
								<div className='blog__content'>
									<span className='blog__content--meta'>February 03, 2022</span>
									<h3 className='blog__content--title'>
										<a href='blog-details'>Consectetur adipisicing. magnam commodi doloribus.</a>
									</h3>
									<a className='blog__content--btn primary__btn' href='blog-details'>
										Read more
									</a>
						...
						<div className='col mb-30'>
							<div className='blog__items'>
								...
								<div className='blog__content'>
									<span className='blog__content--meta'>February 03, 2022</span>
									<h3 className='blog__content--title'>
										<a href='blog-details'>Lorem ipsum, dolor sit amet consectetur are elit.</a>
									</h3>
									<a className='blog__content--btn primary__btn' href='blog-details'>
										Read more
									</a>
						...
						<nav className='pagination justify-content-center'>
							<ul className='pagination__wrapper d-flex align-items-center justify-content-center'>
								<li className='pagination__list'>
									<a href='blog' className='pagination__item--arrow  link '>
								...
								<li className='pagination__list'>
									<a href='blog' className='pagination__item link'>
										2
									</a>
								</li>
								<li className='pagination__list'>
