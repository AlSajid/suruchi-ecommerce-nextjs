export default function Shipping() {
	return (
		<section className='shipping__section shipping__style3 section--padding'>
			<div className='container-fluid'>
				<div className='shipping__style3--inner border-radius-10 d-flex justify-content-between'>
					<div className='shipping__style3--items d-flex align-items-center'>
						<div className='shipping__style3--icon'>
							<svg
						...
						<div className='shipping__style3--content'>
							<h2 className='shipping__style3--content__title'>SECURE SHOPPING</h2>
							<p className='shipping__style3--content__desc'>Free order over $300</p>
						</div>
					</div>
					<div className='shipping__style3--items d-flex align-items-center'>
						<div className='shipping__style3--icon'>
						...
						<div className='shipping__style3--content'>
							<h2 className='shipping__style3--content__title'>ACCEPT PAYMENT</h2>
							<p className='shipping__style3--content__desc'>Visa, Paypal, Master</p>
						</div>
					</div>
					<div className='shipping__style3--items d-flex align-items-center'>
						<div className='shipping__style3--icon'>
						...
						<div className='shipping__style3--content'>
							<h2 className='shipping__style3--content__title'>30 DAY RETURN</h2>
							<p className='shipping__style3--content__desc'>30 day guarantee</p>
						</div>
					</div>
					<div className='shipping__style3--items d-flex align-items-center'>
						<div className='shipping__style3--icon'>
						...
						<div className='shipping__style3--content'>
							<h2 className='shipping__style3--content__title'>24/7 SUPPORT</h2>
							<p className='shipping__style3--content__desc'>Support every time</p>
						</div>
					</div>
				</div>
			</div>
